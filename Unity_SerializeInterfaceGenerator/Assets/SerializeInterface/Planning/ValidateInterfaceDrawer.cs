    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (EditorGUI.EndChangeCheck())
        {
            ...
            else if (newValue is GameObject gameObject)
            {
                ...
                {
                    Debug.LogWarning($"The assigned GameObject does not contain a component that implements the required interface {interfaceAttribute.RequiredType.Name}");
                }
            }
            ...
            {
                Debug.LogWarning($"The assigned object does not implement the required interface {interfaceAttribute.RequiredType.Name}");
            }
        }
    }
}
