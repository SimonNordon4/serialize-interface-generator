...
{
    public readonly struct ReactiveClassGenerator
    {
        ...
        // ReactiveSystem stuff.
       private readonly ISymbol _reactiveSystemTypeSymbol;
        

        public ReactiveClassGenerator(ClassValidator validator,ISymbol typeSymbol, bool printOutput = false)
        {
            ...
            _classDeclaration = validator.ClassDeclaration;
            ...
            _reactiveSystemTypeSymbol = typeSymbol;
        ...
        public void GenerateClass()
        {
            ...
            classSource.Append("\n");
            classSource.AppendLine($"[SerializeField,ValidateInterface(typeof(IHandler<{_reactiveSystemTypeSymbol}>))]");
            classSource.AppendLine($"private List<UnityEngine.Object> _handlersSerialized = new();");
            ...
            classSource.AppendLine("        foreach (var obj in _handlersSerialized)");
            classSource.AppendLine("        {");
            classSource.AppendLine($"            _handlers.Add(obj as IHandler<{_reactiveSystemTypeSymbol}>);");
            classSource.AppendLine("        }");
            classSource.Append("\n");
